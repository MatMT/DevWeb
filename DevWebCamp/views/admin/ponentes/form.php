...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <div class="formulario__contenedor-icono">
            ...
            <input type="url" class="formulario__input--sociales" name="redes[facebook]" placeholder="Facebook" value="<?php echo $redes->facebook ?? '' ?>">
        </div>
    </div>
    ...
    <div class="formulario__campo">
        <div class="formulario__contenedor-icono">
            ...
            <input type="url" class="formulario__input--sociales" name="redes[twitter]" placeholder="Twitter" value="<?php echo $redes->twitter ?? '' ?>">
        </div>
    </div>
    ...
    <div class="formulario__campo">
        <div class="formulario__contenedor-icono">
            ...
            <input type="url" class="formulario__input--sociales" name="redes[youtube]" placeholder="YouTube" value="<?php echo $redes->youtube ?? '' ?>">
        </div>
    </div>
    ...
    <div class="formulario__campo">
        <div class="formulario__contenedor-icono">
            ...
            <input type="url" class="formulario__input--sociales" name="redes[instagram]" placeholder="Instagram" value="<?php echo $redes->instagram ?? '' ?>">
        </div>
    </div>
    ...
    <div class="formulario__campo">
        <div class="formulario__contenedor-icono">
            ...
            <input type="url" class="formulario__input--sociales" name="redes[github]" placeholder="GitHub" value="<?php echo $redes->github ?? '' ?>">
        </div>
    </div>
</fieldset>